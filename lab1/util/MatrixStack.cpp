...
void MatrixStack::rotX(double angle) { rotX(static_cast<float>(angle)); }
...
void MatrixStack::rotY(double angle) { rotY(static_cast<float>(angle)); }
...
void MatrixStack::rotZ(double angle) { rotZ(static_cast<float>(angle)); }
...
void MatrixStack::scale(double s) { scale(static_cast<float>(s)); }
